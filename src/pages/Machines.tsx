...
export default function Machines() {
  ...
  return (
    <>
      ...
      <CTABand heading="Not sure which machine fits your space?" body="Tell us your footfall and venue type — we'll recommend the right fit and product mix." primaryLabel="Get a Recommendation" />
    </>
  );
}
